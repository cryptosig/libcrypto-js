...
test('crypto.generateKeys', function(t) {
  ...
  t.equal(keys.public.slice(0, 3), 'PPY', 'generated public key is in peerplays format');
...
test('crypto.keysFromPassword', function(t) {
  ...
  var publicKeys = [
    ['owner', 'PPY5pZ15FDVAvNKW3saTJchWmSSmYtEvA6aKiXwDtCq2JRZV9KtR9'],
    ['memo', 'PPY5nwJgD9jmkAdTXuiz3jqrkw3om95gCapZo4e4Bcp3qzyiedwCn'],
    ['active', 'PPY5SKxjN1YdrFLgoPcp9KteUmNVdgE8DpTPC9sF6jbjVqP9d2Utq']
  ];
...
test('crypto.PrivateKey', function(t) {
  ...
  t.equal(
    pub.toString(),
    'PPY5SKxjN1YdrFLgoPcp9KteUmNVdgE8DpTPC9sF6jbjVqP9d2Utq',
...
test('crypto.PublicKey', function(t) {
  var priv = crypto.PrivateKey.from('5JamTPvZyQsHf8c2pbN92F1gUY3sJkpW3ZJFzdmfbAJPAXT5aw3');
  var pub = crypto.PublicKey.from('PPY5SKxjN1YdrFLgoPcp9KteUmNVdgE8DpTPC9sF6jbjVqP9d2Utq');
