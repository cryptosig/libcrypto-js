...
hashes and encodings required by the Peerplays platform.
...
```
> crypto = require('@peerplaysio/libcrypto');
```
...
Provides operations over Peerplays secp256k1-based ECC private keys.
```
...
'PPY5pZ15FDVAvNKW3saTJchWmSSmYtEvA6aKiXwDtCq2JRZV9KtR9'
...
Provides operations over Peerplays secp256k1-based ECC public keys.
```
> publicKey = crypto.PublicKey.from('PPY5SKxjN1YdrFLgoPcp9KteUmNVdgE8DpTPC9sF6jbjVqP9d2Utq')
... 
...
Generates a new pair of keys in Peerplays WIF format using cryptographically secure
random number generation.
```
> crypto.generateKeys()
{
  private: "5JCDRqLdyX4W7tscyzyxav8EaqABSVAWLvfi7rdqMKJneqqwQGt",
  public: "PPY5pZ15FDVAvNKW3saTJchWmSSmYtEvA6aKiXwDtCq2JRZV9KtR9"
}
```

### crypto.keysFromPassword(accountName, accountPassword)

Given a Peerplays account name and password, regenerates the derived `owner`,
...
{ owner:
  ...
  memo:
   { private: '5JSmQQJXH5ZrSW3KJSTUPFJy7SuLeDiY3bW6vB1McamxzJQFhwD',
     public: 'PPY5nwJgD9jmkAdTXuiz3jqrkw3om95gCapZo4e4Bcp3qzyiedwCn' },
  active:
   { private: '5JamTPvZyQsHf8c2pbN92F1gUY3sJkpW3ZJFzdmfbAJPAXT5aw3',
     public: 'PPY5SKxjN1YdrFLgoPcp9KteUmNVdgE8DpTPC9sF6jbjVqP9d2Utq' } }
```

## Requirements

peerplays-crypto is written in Javascript as specified by
...
peerplays-crypto explicitly supports the following environments without polyfills:
...
peerplays-crypto explicitly does not support the following environments:
- Opera Mini
